...
**Subtitle:** The Universal Execution Layer for the Agentic Economy  
...
|---|---|---|---|
| `intent` | String | The high-level goal of the agent. | Enum: RESOLVE_OUTAGE, VERIFY_STATE, TRANSPORT_ASSET, GENERATE_DATA |
